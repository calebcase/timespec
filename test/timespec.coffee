                  ...
                  do (timezone) ->
                    for time_base_string, time_base of time_bases
                      ...
                      do () ->
                        ...
                        date_strings = [
                          garburate garbage, time_base_string + 'Jan 2 2040' + period_string
                          garburate garbage, time_base_string + 'Jan 2, 2040' + period_string
                          garburate garbage, time_base_string + '2040-1-2' + period_string
                          garburate garbage, time_base_string + '2.1.2040' + period_string
                          garburate garbage, time_base_string + '2 Jan 2040' + period_string
                          garburate garbage, time_base_string + '1/2/2040' + period_string
                        ]
                      ...
                      do () ->
                        ...
                        date_strings = [
                          garburate garbage, time_base_string + 'Jan 2' + period_string
                          garburate garbage, time_base_string + '2 Jan' + period_string
                        ]
                      ...
                      do () ->
                        ...
                        date_string = garburate garbage, time_base_string + 'Monday' + period_string
                        result = parse garbage, date_string
                        describe "'#{date_string}'", ->
                          target_string = if timezone then target.toUTCString() else target.toString()
                          it "should#{garbage} return '#{target_string}'", ->
                      ...
                      do () ->
                        ...
                        date_string = garburate garbage, time_base_string + 'today' + period_string
                        result = parse garbage, date_string
                        describe "'#{date_string}'", ->
                          target_string = if timezone then target.toUTCString() else target.toString()
                          it "should#{garbage} return '#{target_string}'", ->
                      ...
                      do () ->
                        ...
                        date_string = garburate garbage, time_base_string + 'Tomorrow' + period_string
                        result = parse garbage, date_string
                        describe "'#{date_string}'", ->
                          target_string = if timezone then target.toUTCString() else target.toString()
                          it "should#{garbage} return '#{target_string}'", ->
                      ...
                      do () ->
                        ...
                        date_string = garburate garbage, time_base_string + 'Yesterday' + period_string
                        result = parse garbage, date_string
                        describe "'#{date_string}'", ->
                          target_string = if timezone then target.toUTCString() else target.toString()
                          it "should#{garbage} return '#{target_string}'", ->
                      ...
                      do () ->
                        ...
                        for date_string, target of targets
                          target = rebase target, timezone, time_base
                          mutate(target, period_direction_multiplier * period_count)
                          targets[time_base_string + date_string + period_string] = target
                      ...
                      do () ->
                        ...
                        date_string = garburate garbage, time_base_string + 'next month' + period_string
                        result = parse garbage, date_string
                        describe "'#{date_string}'", ->
                          target_string = if timezone then target.toUTCString() else target.toString()
                          it "should#{garbage} return '#{target_string}'", ->
                      ...
                      do () ->
                        for count in counts
                          do (count) ->
                            ...
                            date_string = garburate garbage, time_base_string + "next #{count} months" + period_string
                            result = parse garbage, date_string
                            describe "'#{date_string}'", ->
                              target_string = if timezone then target.toUTCString() else target.toString()
                              it "should#{garbage} return '#{target_string}'", ->
                      ...
                      do () ->
                        ...
                        for name, day of targets
                          ...
                          date_string = garburate garbage, time_base_string + "NEXT #{name}" + period_string
                          result = parse garbage, date_string
                          describe "'#{date_string}'", ->
                            target_string = if timezone then target.toUTCString() else target.toString()
                            it "should#{garbage} return '#{target_string}'", ->
                      ...
                      do () ->
                        ...
                        date_string = garburate garbage, time_base_string + 'LAST month' + period_string
                        result = parse garbage, date_string
                        describe "'#{date_string}'", ->
                          target_string = if timezone then target.toUTCString() else target.toString()
                          it "should#{garbage} return '#{target_string}'", ->
                      ...
                      do () ->
                        for count in counts
                          do (count) ->
                            ...
                            date_string = garburate garbage, time_base_string + "LAST #{count} months" + period_string
                            result = parse garbage, date_string
                            describe "'#{date_string}'", ->
                              target_string = if timezone then target.toUTCString() else target.toString()
                              it "should#{garbage} return '#{target_string}'", ->
                      ...
                      do () ->
                        ...
                        for name, day of targets
                          ...
                          date_string = garburate garbage, time_base_string + "last #{name}" + period_string
                          result = parse garbage, date_string
                          describe "'#{date_string}'", ->
                            target_string = if timezone then target.toUTCString() else target.toString()
                            it "should#{garbage} return '#{target_string}'", ->
